...
def generator(eem):
    def em(T_inst, n_inst, n_max, T_cont, c_ovr, c_lb, P_rat, type='SPM',
        ...
        if (eem(T_inst, n_inst, n_max, T_cont, c_ovr, c_lb, P_rat, type='SPM',
           T_const=False, P_const=False)[0] == True):
            return  eem(T_inst, n_inst, n_max, T_cont, c_ovr, c_lb, P_rat,
                    type='SPM', T_const=False, P_const=False)[1],
                    (T_inst * n_inst * (11 / 105000) * T_inst, n_inst,
...
print(eeg(230, 3180, 12000, 230, 1.08, 0.08, 75))
