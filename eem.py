...
def eem(T_inst, n_inst, n_max, c_nt, T_cont, c_ovr, c_lb, P_rat, type='SPM',
    ...
    constant torque upper limit as coefficient of the maximum speed,
    ...
    # compute upper speed limit of the continous torque domain
    n_t = n_max * c_nt
